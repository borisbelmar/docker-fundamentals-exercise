...
export default function Login() {
  ...
  const { register, handleSubmit, errors } = useLoginForm({ initialEmail: state?.email || '' })
    ...
    <div className="max-w-md w-full mx-auto flex flex-col justify-center items-center">
      ...
      >
        ...
        <Link
          to="/register"
          replace
          className="text-primary-500 hover:text-primary-300 transition text-sm text-center"
        >
